...
const Footer = () => {
    return (
        <>
            <footer className="bg-primary w-[100%] flex flex-col items-start md:items-center justify-start md:justify-center px-9 md:px-11 xl:px-60 2xl:px-80">
                <div className="w-[100%] flex flex-col md:flex-row justify-center md:justify-between gap-8 lg:gap-32 pt-11 mb-7">
                    <div className="flex flex-col gap-5 mt-2">
                        <div>
                            <ul className="flex flex-col gap-7 text-sm text-white capitalize font-medium tracking-[1px]">
                                <li>
                    ...
                    <div className="flex flex-col gap-5 mt-2">
                        ...
                        <div>
                            <ul className="flex flex-col gap-4 text-sm text-white font-medium tracking-[1px] w-[250px]  md:text-end">
                                <li>
